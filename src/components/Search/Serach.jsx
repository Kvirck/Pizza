...
export const Serach = () => {
    ...
    const { setSearchValue } = React.useContext(SerachContext)
    ...
    return (
        <div className={style.root}>
            ...
            <input ref={inputRef} value={value} onChange={e => onChangeInput(e)}
                className={style.input} placeholder='Поиск Пиццы....' />
            {value && <svg onClick={() => onClickClear()} className={style.clearSearch} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
